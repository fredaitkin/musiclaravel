...
class Words extends Command {
    ...
    private function getWordCloud($song_ids, $artist_ids)
    {
        ...
        $query = Song::select('songs.id', 'title', 'lyrics')
            ...
            ->whereNotIn('songs.id', [
                908, 911, 1273, 1425, 2225, 3966, 3994, 4145, 4146,
                4361, 4389, 4624, 4732, 4892, 5325, 5621, 5709, 5727, 5728, 5737, 6053, 6218, 6502, 6912, 8036, 8456, 8532, 8587, 4856, 8993, 9143, 9146, 9159, 9164, 9183, 9473, 9550, 9741, 9749, 9762,
            ])
